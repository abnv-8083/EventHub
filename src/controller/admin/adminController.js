...
export const postApproveKyc = async (req, res) => {
    try {
        ...
        // generate one-time organizer password
        ...
        try {
            ...
            if (user && user.email) {
                await sendOrganizerCredentials({ email: user.email, name: user.name, password: tempPassword });
            }
        } catch (emailError) {
...
export const getUsersList = async (req, res) => {
    try {
        // Seed demo users during development/testing to verify pagination
